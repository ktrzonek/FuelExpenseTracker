    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                    ...
                    <c:forEach items="${tripExpenses}" var="tripExpense">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<c:url value='/tripExpense/delete/${tripExpense.id}?tripId=${tripId}&carId=${carId}' />">Delete</a>
                ...
                <div>
                    <h1 class="h5 mb-0 font-weight-bold text-primary"> You have spent ${totalTripExpense} PLN on this trip in total</h1>
                </div>
